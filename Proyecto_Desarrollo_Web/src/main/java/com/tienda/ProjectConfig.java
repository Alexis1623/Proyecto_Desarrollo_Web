...
public class ProjectConfig implements WebMvcConfigurer {
    //Los siguientes metodos son utilizados para el tema de internacionaliZaci+On 
    //LocaleResolver se utiliza para gestionar la configuracion  del idioma según la ubicacion del usuario
